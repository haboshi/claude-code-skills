...
### `export --in <file> --out <file> [--format svg|png|pdf|xml] [--border 10] [--layout <preset>] [--no-embed]`
...
### `inline --in <file.drawio|file.svg> [--out <file>] [--id-prefix <p>] [--max-width 780] [--no-font-fallback]`
