...
本表は全 26 チェック（`check_id`）を、**CWE・OWASP Top 10:2025・OWASP WSTG v4.2・
...
| `info-disclosure-banner` | サーバ/フレームワークのバージョン露出 | CWE-200 | A01:2025-アクセス制御の不備 | WSTG-INFO-02 | v5.0.0-13.4.6 (L3) | `AV:N/AC:L/AT:N/PR:N/UI:N/VC:L/VI:N/VA:N/SC:N/SI:N/SA:N` | 6.9（Medium） |
...
計 26 チェック（OWASP 内訳: A01=6 / A02=6 / A03=2 / A04=4 / A05=1 / A06=5 / A08=1 / A10=1）。
